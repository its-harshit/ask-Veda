...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:static inset-y-0 left-0 z-40 w-16 md:w-16 hover:w-80 bg-background-primary border-r border-gray-200 transform transition-all duration-300 ease-in-out group`}>
        <div className="flex flex-col h-full">
              ...
              {isLoadingChats ? (
                ...
                chats.map((chat) => (
                  <div
                    ...
                    className={`flex items-center space-x-3 p-3 rounded-lg hover:bg-background-tertiary transition-colors cursor-pointer opacity-0 group-hover:opacity-100 group-hover:flex ${
          ...
          <div className="p-4 border-t border-gray-200 space-y-2">
            ...
            <button className="flex items-center space-x-3 px-1 py-3 rounded-xl hover:bg-background-tertiary transition-colors cursor-pointer w-full group-hover:justify-start opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              <AlertTriangle className="w-5 h-5 text-gray-500 flex-shrink-0" />
              <span className="text-sm whitespace-nowrap">Complaints</span>
            </button>
            ...
            <button 
              ...
              className="flex items-center space-x-3 px-1 py-3 rounded-xl hover:bg-danger-50 transition-colors cursor-pointer w-full text-danger-600 hover:text-danger-700 group-hover:justify-start opacity-0 group-hover:opacity-100 transition-opacity duration-200"
            >
